    ...
    <>
      <Row>
        <Col md={6} xs={12}>
          ...
          <div>
            <div>
              <p> Hi Everyone, I am Doan from Ho Chi Minh, VietNam.</p>

              <p> I am student at FPT University HCM</p>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-center brand-red">-- Peter Drucker --</p>
          </div>
        </Col>
        <Col
          md={6}
                ...
                <div className="p-3 relative">
                  <div className="experience-container">
                    ...
                    <div className="details">
                      ...
                      <div className="info">
                        <p className="title">Learning Software Engineering</p>
                        <p className="company">FPT University Ho Chi Minh</p>
                      </div>
                    </div>
                  </div>
                </div>
